            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        ...
                        <p className="max-w-[410px] mt-6 text-sm">Welcome to TradeFair, your trusted African marketplace connecting buyers with verified vendors. Discover quality products, from local crafts to modern electronics — all in one trusted platform.</p>
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2025 © TradeFair. All Rights Reserved.
                </p>
            </div>
        </footer>
    );
