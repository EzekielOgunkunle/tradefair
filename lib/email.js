            ...
            <div class="order-details">
              ...
              ${order.items.map(item => `
                <div class="order-item">
                  ...
                  <div>₦${(item.priceCents / 100).toLocaleString()}</div>
                </div>
              `).join('')}
              
              <div class="total">
                Total: ₦${(order.totalAmountCents / 100).toLocaleString()}
              </div>
            </div>
        ...
        <div class="container">
          ...
          <div class="content">
            ...
            <div class="order-details">
              ...
              <p><strong>Total:</strong> ₦${(order.totalAmountCents / 100).toLocaleString()}</p>
            </div>
